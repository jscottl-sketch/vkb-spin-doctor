...
MCC is the single-pane-of-glass for all project activity. Two files on Desktop:
...
### Provider Status (as of 18 May 2026)
...
| Agent guesses wrong path | Path injection is in v3 — if broken, check VKB_SpinDoctor_Handover_v38.md is present |
