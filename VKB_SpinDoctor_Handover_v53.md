# VKB Spin Doctor — Project Handover v53 (MASTER)
...
| Handover injection | Loads VKB_SpinDoctor_Handover_v53.md into system prompt on startup |
...
├── VKB_SpinDoctor_Handover_v53.md     # This file — read by sfl_agent on startup
├── problems/
│   ├── __init__.py
...
| Agent guesses wrong path | Path injection is in v3 — if broken, check VKB_SpinDoctor_Handover_v53.md is present |
