...
HANDOVER_FILENAME = "PROJECT_HANDOVER.md"
...
def ask_claude(screenshot_b64, task, memory, system_prompt):
    """Returns (raw_text, usage_dict). usage_dict has 'input' and 'output'
    integer token counts for the v3 (D) budget tracker."""
...
def parse_response(raw):
    ...
    try:
        ...
        return thought, action, command or question, done
