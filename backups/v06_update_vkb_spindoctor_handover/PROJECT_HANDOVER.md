...
**Status:** ACP v1 built. GUI 3 tabs confirmed working. sfl_agent.py v3 (575 lines). Conductor module live.
...
| # | Task | Tool |
|---|---|---|
| 1 | Test sfl_agent with `--budget 30k` on a real task | Manual |
| 2 | Rename handover constant in sfl_agent.py from `v12` to `PROJECT_HANDOVER.md` | Claude Code |
| 3 | v0.2 spin fix — Elite Dangerous | Claude Code |
| 4 | ED Bind Reset prevention (Module 07) | Claude Code |
| 5 | Wire conductor recommendations into GUI | Claude Code |
| 6 | win_hardener module (9 problems) | Claude Code |
